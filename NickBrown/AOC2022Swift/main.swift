...
func day_21(){
    let r = Day21("/Users/Nick/Documents/GitHub/AdventOfCode/NickBrown/AOC2022Swift/inputs/day21.txt", "\n")
    print("Day 21 Part 1: \(r.part1())")
    print("Day 21 Part 2: \(r.part2())")
}
day_21()
let day21finish = CACurrentMediaTime()
print("Day 21 execution time: \(day21finish - day18finish)")
